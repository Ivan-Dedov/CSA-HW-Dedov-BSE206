...
В связи с такими изменениями, увеличилось количество файлов с исходным кодом, но самого кода стало меньше, так как появилось больше возможностей для использования одного и того же функционала (reusable code). Отсюда более маленький расход памяти на хранение файлов с кодом. Также программисту проще читать код, написанный в объектно-ориентированном стиле, так как он более понятен.
